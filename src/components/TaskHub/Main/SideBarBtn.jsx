...
export default function SideBarBtn() {
  ...
  return (
      <label name='sidebar-button' className='z-20 flex justify-center items-center w-[58px] h-[58px] p-3 rounded-lg select-none scale-90 bg-[#2196F3] cursor-pointer' htmlFor="burger">
