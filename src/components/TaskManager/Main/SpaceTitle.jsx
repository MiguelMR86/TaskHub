...
function SpaceTitle() {
  ...
  return currentSpace ? (
    <div className="flex justify-center items-center gap-4 h-[60px] ml-4">
      <h1 className="font-bold text-[23px] sm:text-4xl bg-red-500 w-[210px] sm:w-full truncate text-ellipsis">{currentSpace.name}</h1>
      <img
